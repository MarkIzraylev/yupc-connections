# Generated by Django 5.0.7 on 2024-08-15 18:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='ОСНОВНОЙ КУРС', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='ComplaintTypes',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='1 КУРС', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Department',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='ОИТ', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Hobby',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='УЧЕБА В ЯГК', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('description', models.TextField(blank=True, default='Ищу друзей', max_length=170, null=True)),
                ('is_search_friend', models.BooleanField(default=False)),
                ('is_search_love', models.BooleanField(default=False)),
                ('vk_contact', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ('tg_contact', models.CharField(blank=True, default=None, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('swiper_is_like', models.BooleanField(blank=True, default=False, null=True)),
                ('swiped_is_like', models.BooleanField(blank=True, default=False, null=True)),
